    ...
    <div class="alert alert-info" role="alert">
        ...
        <form action="" method="POST">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="alternat_mobile">Alternative Mobile</label>
                        <input type="text" class="form-control" id="alternat_mobile" placeholder="Alternative Mobile" name="alternat_mobile" value="<?php echo $data['alternat_mobile']?$data['alternat_mobile']:''; ?>">
                    </div>
                </div>
            </div>
