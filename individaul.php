		  	 ...
		  	 <div class="row">
				...
				<div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" pattern="^(\d{10})$" id="mobile" title="10 digit phone number" placeholder="10 digit mobile number" name="mobile" required>
				  </div>
				 </div>
				...
				<div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" pattern="^(\d{10})$" id="alternat_mobile" title="10 phone mobile number" placeholder="10 digit mobile number" name="alternat_mobile">
				  </div>
				</div>
			</div>
			...
			<div class="row">
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="plot_number" placeholder="Plot Number" name="plot_number" required>
				  </div>
				 </div>
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="rooms" placeholder="number" name="rooms" required>
				  </div>
				 </div>
			</div>
